...
const (
	...
	AStudyInHistory_SynchronizeFor_FullMethodName = "/daemon.AStudyInHistory/SynchronizeFor"
...
type AStudyInHistoryClient interface {
	...
	SynchronizeFor(ctx context.Context, in *SynchronizeForRequest, opts ...grpc.CallOption) (*SynchronizeForResponse, error)
...
func (c *aStudyInHistoryClient) SynchronizeFor(ctx context.Context, in *SynchronizeForRequest, opts ...grpc.CallOption) (*SynchronizeForResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SynchronizeForResponse)
	err := c.cc.Invoke(ctx, AStudyInHistory_SynchronizeFor_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AStudyInHistoryServer interface {
	...
	SynchronizeFor(context.Context, *SynchronizeForRequest) (*SynchronizeForResponse, error)
...
func (UnimplementedAStudyInHistoryServer) SynchronizeFor(context.Context, *SynchronizeForRequest) (*SynchronizeForResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SynchronizeFor not implemented")
}
...
func _AStudyInHistory_SynchronizeFor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SynchronizeForRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AStudyInHistoryServer).SynchronizeFor(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AStudyInHistory_SynchronizeFor_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AStudyInHistoryServer).SynchronizeFor(ctx, req.(*SynchronizeForRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AStudyInHistory_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SynchronizeFor",
			Handler:    _AStudyInHistory_SynchronizeFor_Handler,
		},
		{
